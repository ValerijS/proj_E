...
router.route('/admin')
  ...
  .get(controllers.admin_schools, controllers.render('views/boots_tiles_04_09.pug'))
...
router.put('/admin_schools/:name', controllers.insert_new_school_04_09_a, controllers.render('views/school.pug')); 
